...
class Collectorsorders extends StatefulWidget {
  final cl;

  const Collectorsorders({Key key, this.cl}) : super(key: key);
  @override
  _CollectorsordersState createState() => _CollectorsordersState();
}

class _CollectorsordersState extends State<Collectorsorders> {
...
orders=[];
   ...
   loading=true;
    ...
    String link=
      ...
      "$host/users/collector/orders/my?limit=11&page=$page";
