...
class ClientLoc extends StatefulWidget {
  final client;

  const ClientLoc({Key key, this.client}) : super(key: key);
  @override
  State<ClientLoc> createState() => ClientLocState();
}

class ClientLocState extends State<ClientLoc> {
...
@override
  ...
  position: LatLng(
    ...
    double.tryParse( widget.client['latitude'],),
    
    double.tryParse( widget.client['longitude'],)
